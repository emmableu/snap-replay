...
//
//
//     static logExecutionTrace (blockId, testRunner, vm, target) {
//         const allTargets = [];
...
//      */
//     static prepareClasses (classes, testRunner, vm) {
...
//                 CoverageGenerator.logExecutionTrace(blockId, testRunner, vm, this.target)
//             };
//         }
